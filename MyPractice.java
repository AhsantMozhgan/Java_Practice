//1- (Finding the factors of an integer) Write a program that reads an integer and displays all its smallest
// factors in increasing order. For example, if the input integer is 120, the output should be as
// follows: 120=2* 2*2* 3*5.

//        2- (Displaying pyramid) Write a program that prompts the user to enter an integer from 1 to 15 and
